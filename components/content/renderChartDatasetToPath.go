...
func renderChartDatasetToPath(dataset *data.Dataset, width int, height int, min_value int64, max_value int64, property string) string {

	delta_x := int(width / dataset.Length())
